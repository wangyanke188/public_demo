...
import com.fzy.domain.UserRoleDO;
import com.fzy.domain.UserVO;
import com.fzy.system.dao.DeptDao;
import com.fzy.system.dao.UserDao;
import com.fzy.system.dao.UserRoleDao;
import com.fzy.system.service.FileService;
import com.fzy.system.service.UserService;
import com.fzy.system.utils.MD5Utils;
import com.fzy.utils.BuildTree;
import com.fzy.utils.FileType;
import com.fzy.utils.FileUtil;
import com.fzy.utils.ImageUtils;
...
//    @Cacheable(key = "#id")
    ...
    public int update(UserDO user) {
        int r = userMapper.update(user);//修改用户信息
        Long userId = user.getUserId();
        List<Long> roles = user.getRoleIds();
        userRoleMapper.removeByUserId(userId);
        List<UserRoleDO> list = new ArrayList<>();
